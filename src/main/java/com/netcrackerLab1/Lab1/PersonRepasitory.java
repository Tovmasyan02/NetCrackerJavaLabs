...
public class PersonRepasitory implements Iterator<Person>, Iterable<Person> {
	...
	/**
	 * Индекс следующей ячейки где должна программа добавить следю экземпляр при
	 * вызове метода add
	 */
	...
	/**
	 * Конструктор без параметров создает массив в длинной Capacity(которая есть по
	 * умолчанию)
	 */
	 ...
	 * 
	 * @param person новый экземпляр который надо добавить
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PersonRepasitory other = (PersonRepasitory) obj;
		if (capacity != other.capacity)
			return false;
		if (!Arrays.equals(persons, other.persons))
			return false;
		return true;
	}
